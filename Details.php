...
<body>
  ...
  <table>
    ...
    $username = "root";
    $password = "";
    $conn = mysqli_connect($server, $username, $password, "pashya");
    if (!$conn) {
    ...
    if (isset($_SESSION['user'])) {
      ...
      $sql = "SELECT * FROM pashya WHERE name='$user'";
    ...
    <div class="card container">
      ...
      <form action="transfer.php" method="POST">
        ...
        <select name="reciever" id="dropdown" class="textbox" required>
          ...
          <?php
          $db = mysqli_connect("localhost", "root", "", "pashya");
          $res = mysqli_query($db, "SELECT * FROM pashya WHERE name!='$user'");
