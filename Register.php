  ...
  <body >
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST'){
                ...
                if (!$conn){
                    ...
                    $sql = "INSERT INTO `pashya`.`pashya` (`ac`,`name`, `email`, `gender`, `balance`) VALUES ('$account','$name', '$email', '$gender', '$balance')";
                ...
                <div class="row g-0 pt-5">
                    ...
                    <div class="col-lg-7 text-center py5">
                        ...
                        <form action="Register.php" method="post">
							...
							<div class="form-row pt-5 ">
                                <div class="offset-1 col-lg-10">
                                    <input name="ac" type="text" class="inp px-3" placeholder="Account Number">
                                </div>
                            </div>
